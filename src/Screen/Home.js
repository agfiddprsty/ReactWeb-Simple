                    ...
                    <div>
                        ...
                        <div className="list-group">
                            <div className="text-center">
                                <h1 style={{fontSize:'30px', color:'red', fontWeight:600, paddingBottom: "50px"}}>Cara Kerja</h1>
                            </div>
                            <br/>
                        ...
                        <div className="text-center"><br/>
                            <h1 style={{fontSize:'30px',color:'red', marginTop: "50px", fontWeight: '600', marginBottom: "50px"}}>Mengapa Memilih Kami?</h1>
                        </div>
                        ...
                        <div className="text-center">
                            <p style={{color: "red", fontSize: "20px", fontWeight: '600', padding: "50px 0 50px 0"}}>Perusahaan Rekanan</p>
                        </div>
                        <div className="row text-center">
                        ...
                        <div>
                            <p className="text-center" style={{color: "red", fontSize: "20px", fontWeight: '600', padding: "50px 0 50px 0"}}>Teknologi</p>
                        </div>
                        <div className="row text-center">
                            <div className="col-lg-2 col-md-2 col-sm-2 col-xs-2">
