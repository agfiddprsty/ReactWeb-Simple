      ...
      return (
        ...
        <Header/>
              ...
              <div style={{padding:'0 0 20px 0', backgroundColor:'#FFF'}}>
                    <div class="agreement" style={{boxShadow:'0 0 20px 1px rgba(136, 136, 136, 0.4)', width:'59.7%', padding:'50px 40px 50px 40px', backgroundColor:'#FFF', position:'center', margin:'80px 0 80px 275px', border:'1px solid #ececec'}}> 
