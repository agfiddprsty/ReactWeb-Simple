                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <ul class="nav flex-column nav-pills" style={{backgroundColor:"#FFF",width:"400px"}}>
                                <li class="nav-item">
                                    <a class="nav-link active fa fa-square-o " href="#vtab1" data-toggle="tab"> Membuat Component Dengan Gelap<i className="fa fa-check-circle" style={{marginLeft:"50px",borderRadius:"10px",color:"#4CAF50"}}></i></a>
                                </li>
                                <li class="nav-item">
